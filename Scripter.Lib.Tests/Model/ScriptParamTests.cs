...
{
    [Theory]
    [InlineData(nameof(ScriptParam.Project.RepoFolder), "AppStarter")]
    [InlineData(nameof(ScriptParam.Project.AppProjFolder), "AppStarter.ConsoleApp")]
    ...
    [InlineData(nameof(ScriptParam.RepoPath), @"C:\kmazanek@gmail.com\Code\AppStarter")]
