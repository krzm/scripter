...
public class BuildAllScriptTests : ScriptTestBase
{
    ...
    [InlineData(25, $"& \"$PSScriptRoot\\DotNetTool.Build.ps1\"")]
    [InlineData(26, $"& \"$PSScriptRoot\\Inventory.Data.Build.ps1\"")]
    [InlineData(27, $"& \"$PSScriptRoot\\Inventory.Wizard.Lib.Build.ps1\"")]
    [InlineData(28, $"& \"$PSScriptRoot\\Inventory.Console.Lib.Build.ps1\"")]
    [InlineData(29, $"& \"$PSScriptRoot\\Inventory.Modern.Lib.Build.ps1\"")]
    [InlineData(30, $"& \"$PSScriptRoot\\Inventory.ConsoleLib.ConsoleApp.Build.ps1\"")]
    [InlineData(31, $"& \"$PSScriptRoot\\Inventory.Modern.ConsoleApp.Build.ps1\"")]
    [InlineData(32, $"& \"$PSScriptRoot\\Diybox.ConsoleApp.Build.ps1\"")]
    [InlineData(33, $"& \"$PSScriptRoot\\GameData.ConsoleApp.Build.ps1\"")]
    [InlineData(34, $"& \"$PSScriptRoot\\Commander.Build.ps1\"")]
    [InlineData(35, $"& \"$PSScriptRoot\\TRMApi.Build.ps1\"")]
    [InlineData(36, $"& \"$PSScriptRoot\\Portal.Build.ps1\"")]
    [InlineData(37, $"& \"$PSScriptRoot\\WpfHelper.Build.ps1\"")]
    [InlineData(38, $"& \"$PSScriptRoot\\Pattern.Build.ps1\"")]
    [InlineData(39, $"& \"$PSScriptRoot\\Net.Examples.Build.ps1\"")]
    [InlineData(40, $"& \"$PSScriptRoot\\UnityContainer.Tests.Build.ps1\"")]
    [InlineData(41, $"& \"$PSScriptRoot\\CommandDotNet.Examples.App.Build.ps1\"")]
