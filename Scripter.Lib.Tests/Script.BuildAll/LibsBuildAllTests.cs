        ...
        , IClassFixture<LibsListFixture>
{
    ...
    [InlineData(9, $"& \"$PSScriptRoot\\ModelHelper.Build.ps1\"")]
    [InlineData(10, $"& \"$PSScriptRoot\\CommandDotNet.Helper.Build.ps1\"")]
    [InlineData(11, $"& \"$PSScriptRoot\\CommandDotNet.MDI.Helper.Build.ps1\"")]
    [InlineData(12, $"& \"$PSScriptRoot\\CommandDotNet.IoC.Unity.Build.ps1\"")]
    [InlineData(13, $"& \"$PSScriptRoot\\CommandDotNet.Unity.Helper.Build.ps1\"")]
